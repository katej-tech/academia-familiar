...
function screenAdultHome(){setTheme("adulto");
 ...
 render(topbar("screenStart()")
  ...
  +'<button class="abtn" style="text-align:left;display:flex;align-items:center;gap:14px" onclick="screenWordVault()"><span style="font-size:2rem">🗃️</span><span style="flex:1"><b>Baúl de palabras</b><br><span class="mut" style="font-size:.82rem">Palabras que marcaste para repasar</span></span></button>'
